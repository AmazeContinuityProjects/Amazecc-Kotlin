...
| H12 "Removed fontSize overrides" | 100+ `fontSize = X.sp` remain: TasksScreen ~25, ODTrackerScreen 12, CourseDashboard 11, CalendarScreen 9, FreeClassrooms 11, AttendanceScreen 5, CourseAttendanceScreen 5, CircularsScreen 5, CurriculumScreen 6, DailyPlanner 4 (incl. `48.sp` emoji 🎉 :335, `8.sp` x3 :282-298), TimetableComponents 4, GPAPredictor 2, GradesScreen 1 — incl. sub-10sp sizes (unreadable: TasksScreen :446 `8.sp`, :436/:1055 `9.sp`) |
